...
public class EmailJakartaService
{
    ...
    public EmailJakartaService (String host, int port, String username, String password) {
        prop = new Properties();
    ...
    public EmailJakartaService (String host, int port) {
        prop = new Properties();
        prop.put("mail.smtp.host", host);
        prop.put("mail.smtp.port", port);
    }
    ...
    public static void main(String... args) {
        try {
            new EmailJakartaService("smtp.mailtrap.io", 25, "87ba3d9555fae8", "91cb4379af43ed")
                .sendMail();
        } catch (Exception e) {
            e.printStackTrace();
        }
